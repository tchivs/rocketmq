...
public class MessageConst {
    ...
    public static final String PROPERTY_RECOVERABLE_TRANSACTION = "RMQ_RTX";
    public static final String PROPERTY_RECOVERABLE_TRANSACTION_VERSION = "RMQ_RTX_VERSION";
    public static final String PROPERTY_RECOVERABLE_TRANSACTION_PREFIX = "RMQ_RTX_PREFIX";
    public static final String PROPERTY_RECOVERABLE_TRANSACTION_OWNER_EPOCH = "RMQ_RTX_OWNER_EPOCH";
    public static final String PROPERTY_RECOVERABLE_TRANSACTION_CLAIMANT_EPOCH = "RMQ_RTX_CLAIMANT_EPOCH";
    public static final String PROPERTY_RECOVERABLE_TRANSACTION_OWNER_SLOT = "RMQ_RTX_OWNER_SLOT";
    public static final String PROPERTY_RECOVERABLE_TRANSACTION_CHECKPOINT = "RMQ_RTX_CHECKPOINT";
    public static final String PROPERTY_RECOVERABLE_TRANSACTION_SEQUENCE = "RMQ_RTX_SEQUENCE";
    public static final String PROPERTY_RECOVERABLE_TRANSACTION_HANDLE = "RMQ_RTX_HANDLE";
    public static final String PROPERTY_RECOVERABLE_TRANSACTION_PAYLOAD_DIGEST = "RMQ_RTX_PAYLOAD_DIGEST";
    public static final String PROPERTY_RECOVERABLE_TRANSACTION_RECORD_TYPE = "RMQ_RTX_RECORD_TYPE";
    public static final String PROPERTY_RECOVERABLE_TRANSACTION_DECISION = "RMQ_RTX_DECISION";
    public static final String PROPERTY_RECOVERABLE_TRANSACTION_DIGEST = "RMQ_RTX_DIGEST";
    public static final String PROPERTY_RECOVERABLE_TRANSACTION_COUNT = "RMQ_RTX_COUNT";
    public static final String PROPERTY_RECOVERABLE_TRANSACTION_JOB_ID = "RMQ_RTX_JOB_ID";
    public static final String PROPERTY_RECOVERABLE_TRANSACTION_ATTEMPT = "RMQ_RTX_ATTEMPT";
    public static final String PROPERTY_RECOVERABLE_TRANSACTION_RESTORED_CHECKPOINT = "RMQ_RTX_RESTORED_CHECKPOINT";
    public static final String PROPERTY_RECOVERABLE_TRANSACTION_CLAIM_MODE = "RMQ_RTX_CLAIM_MODE";
    public static final String PROPERTY_RECOVERABLE_TRANSACTION_CLAIMANT_ID = "RMQ_RTX_CLAIMANT_ID";
    public static final String PROPERTY_RECOVERABLE_TRANSACTION_COMPLETION_OFFSET = "RMQ_RTX_COMPLETION_OFFSET";
    ...
    static {
        ...
        STRING_HASH_SET.add(PROPERTY_RECOVERABLE_TRANSACTION);
        STRING_HASH_SET.add(PROPERTY_RECOVERABLE_TRANSACTION_VERSION);
        STRING_HASH_SET.add(PROPERTY_RECOVERABLE_TRANSACTION_PREFIX);
        STRING_HASH_SET.add(PROPERTY_RECOVERABLE_TRANSACTION_OWNER_EPOCH);
        STRING_HASH_SET.add(PROPERTY_RECOVERABLE_TRANSACTION_CLAIMANT_EPOCH);
        STRING_HASH_SET.add(PROPERTY_RECOVERABLE_TRANSACTION_OWNER_SLOT);
        STRING_HASH_SET.add(PROPERTY_RECOVERABLE_TRANSACTION_CHECKPOINT);
        STRING_HASH_SET.add(PROPERTY_RECOVERABLE_TRANSACTION_SEQUENCE);
        STRING_HASH_SET.add(PROPERTY_RECOVERABLE_TRANSACTION_HANDLE);
        STRING_HASH_SET.add(PROPERTY_RECOVERABLE_TRANSACTION_PAYLOAD_DIGEST);
        STRING_HASH_SET.add(PROPERTY_RECOVERABLE_TRANSACTION_RECORD_TYPE);
        STRING_HASH_SET.add(PROPERTY_RECOVERABLE_TRANSACTION_DECISION);
        STRING_HASH_SET.add(PROPERTY_RECOVERABLE_TRANSACTION_DIGEST);
        STRING_HASH_SET.add(PROPERTY_RECOVERABLE_TRANSACTION_COUNT);
        STRING_HASH_SET.add(PROPERTY_RECOVERABLE_TRANSACTION_JOB_ID);
        STRING_HASH_SET.add(PROPERTY_RECOVERABLE_TRANSACTION_ATTEMPT);
        STRING_HASH_SET.add(PROPERTY_RECOVERABLE_TRANSACTION_RESTORED_CHECKPOINT);
        STRING_HASH_SET.add(PROPERTY_RECOVERABLE_TRANSACTION_CLAIM_MODE);
        STRING_HASH_SET.add(PROPERTY_RECOVERABLE_TRANSACTION_CLAIMANT_ID);
        STRING_HASH_SET.add(PROPERTY_RECOVERABLE_TRANSACTION_COMPLETION_OFFSET);
    }
}
