...
public class TopicValidator {
    ...
    public static final String RMQ_SYS_RECOVERABLE_TRANS_OUTCOME_TOPIC = "RMQ_SYS_RECOVERABLE_TRANS_OUTCOME";
    ...
    static {
        ...
        SYSTEM_TOPIC_SET.add(RMQ_SYS_RECOVERABLE_TRANS_OUTCOME_TOPIC);
        ...
        NOT_ALLOWED_SEND_TOPIC_SET.add(RMQ_SYS_RECOVERABLE_TRANS_OUTCOME_TOPIC);
